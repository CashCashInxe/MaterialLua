...
local Themes = {
	LightRemake = {
		...
		NavBar = Color3.fromRGB(118,165,175),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(118,165,175),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(118,165,175),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(118,165,175),
		Content = Color3.fromRGB(118,165,175),
		Button = Color3.fromRGB(118,165,175),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(118,165,175),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(118,165,175),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(118,165,175),
		Toggle = Color3.fromRGB(118,165,175),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(118,165,175),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(118,165,175),
		TextField = Color3.fromRGB(118,165,175),
		TextFieldAccent = Color3.fromRGB(118,165,175),
	},
	Dark = {
